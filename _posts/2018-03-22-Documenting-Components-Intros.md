...
*Сетка (Grid)* или *макет (Layout)* или *Макет сетки (Layout Grid)*, или *Строки (Rows)* и *Колонны (Columns)*, или *Коробка (Box)*, или *Пропорциональная сетка (Proportional Grid)*, или неважно как вы называете невидимую *Разметку страницы (scaffolding)*, визуально упорядочивающию страницу. 
...
Название компонента, используемого для "Установки визуального порядка на странице с помощью строк и столбцов" в 21 библиотеке.
