...
С навигацией хитрее. В контексте обозначение компонента, единственное число наиболее расплывчатое, так что подумайте о том, чтобы вообще его избегать. Но для остальных примеров множественное число - Footers, Grids и Mastheads — работает просто отлично.
